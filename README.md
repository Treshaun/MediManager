...
MediManager is a single-module Android app that helps small clinics manage patients, consultations, and appointments. The app is written in Java 17, targets Android SDK 36 (min 23), and uses Material 1.13 with view binding.
...
- Java 17 with AndroidX AppCompat, RecyclerView, ConstraintLayout
...
1. **Requirements**: Android Studio Giraffe+ (or command-line tools), Java 17-compatible JDK, Android SDK 23–36.
2. **Clone** the repo:
